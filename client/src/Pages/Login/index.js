      ...
      <Container fluid className="context-cor">
        ...
        <Row className="conteudo-principal">
            <Col className="centralizado-center">
                ...
                <div className="container-login centralizado-center">
                    <Form className="centralizado" onSubmit={handleSignIn}>
                      <Form.Group>
                      ...
                      <button className="btn-login">{loadingAuth ? "Carregando..." : "Consultar denúncia"}</button>
                    </Form>
                </div>
